...
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='MTc4OTgtbWFzYWRh',host='127.0.0.1',database='sales')
...
dsn_uid = "nnd99987"        # e.g. "abc12345"
dsn_pwd = "sRGlBpqj1aCU0W05"      # e.g. "7dBZ3wWt9XN6$o0J"
...
def get_last_rowid():
    ...
    res = ibm_db.fetch_both(statement)
    print(res)
